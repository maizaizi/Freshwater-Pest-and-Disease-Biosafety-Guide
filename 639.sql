...
CREATE TABLE UploadedImages (
    ...
    FreshwaterID INT,
    FOREIGN KEY (FreshwaterID) REFERENCES FRESHWATER_PEST_AND_DISEASE_BIOSECURITY_GUIDE(FreshwaterID)
);
...
ALTER TABLE FRESHWATER_PEST_AND_DISEASE_BIOSECURITY_GUIDE
ADD COLUMN ImageFilename VARCHAR(255),
ADD COLUMN AdditionalFilename VARCHAR(255);
